...
* Add testrunner-override flag
* Pass arbitrary JQ args to rpc pre/post filters
...
* Only write GHZ report to REPORT_FILE if TEST_UNDECLARED_OUTPUTS_DIR exists
* Replace diff in rpc_diff_test_runner with diff_test rule
...
* Add buf to functionaltest-cli
* Add jq_raw parameter to ghz_test_runner and rpc_diff_test_runner
...
* Add docker stages to generate bazel docs
* Add LONG_ID and SHORT_ID to jq in rpc_diff_test


### Bug Fixes

* Drop support for test-tools.tar
* Move .bazelrc into embed dir
* Remove explicit tags args, propagate these via kwargs
...
* Add protoc to functionaltest-cli image


### Bug Fixes

* Switch to azure-cli pypi package


### Dependencies

* **deps:** Upgrade azure-cli to 2.74.0
